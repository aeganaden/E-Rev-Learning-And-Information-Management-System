...
CREATE TABLE IF NOT EXISTS `u586422956_erev`.`schedule` (
  ...
  `lecturer_id` INT(20) NULL DEFAULT 999999999,
  `offering_id` INT(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `u586422956_erev`.`course_modules` (
  `course_modules_id` INT(20) NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_course_modules_topic1_idx` (`topic_id` ASC),
  CONSTRAINT `fk_course_modules_topic1`
    FOREIGN KEY (`topic_id`)
    REFERENCES `u586422956_erev`.`topic` (`topic_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `u586422956_erev`.`remedial_grade_assessment` (
  ...
  INDEX `fk_grade_assessment_student1_idx` (`student_id` ASC),
  INDEX `fk_grade_assessment_courseware1_idx` (`courseware_id` ASC),
  INDEX `fk_remedial_grade_assessment_remedial_coursewares1_idx` (`remedial_coursewares_id` ASC),
  ...
  CONSTRAINT `fk_grade_assessment_courseware10`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_remedial_grade_assessment_remedial_coursewares1`
    FOREIGN KEY (`remedial_coursewares_id`)
    REFERENCES `u586422956_erev`.`remedial_coursewares` (`remedial_coursewares_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `u586422956_erev`.`login_sessions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u586422956_erev`.`login_sessions` (
  `login_sessions_id` INT(20) NOT NULL AUTO_INCREMENT,
