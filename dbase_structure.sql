...
CREATE TABLE IF NOT EXISTS `engineering`.`remedial_student_answer` (
  ...
  INDEX `fk_student_answer_choice1_idx` (`choice_id` ASC),
  INDEX `fk_student_answer_student1_idx` (`student_id` ASC),
  INDEX `fk_remedial_student_answer_remedial_grade_assessment1_idx` (`remedial_grade_assessment_id` ASC),
  ...
  CONSTRAINT `fk_student_answer_student10`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_remedial_student_answer_remedial_grade_assessment1`
    FOREIGN KEY (`remedial_grade_assessment_id`)
    REFERENCES `engineering`.`remedial_grade_assessment` (`remedial_grade_assessment_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
