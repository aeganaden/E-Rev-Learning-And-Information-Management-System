...
CREATE TABLE IF NOT EXISTS `engineering`.`courseware_question` (
  ...
  `courseware_question_reference` VARCHAR(800) GENERATED ALWAYS AS () VIRTUAL,
  ...
  INDEX `fk_courseware_question_topic1_idx` (`topic_id` ASC),
  CONSTRAINT `fk_courseware_question_grade_assessment1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_courseware_question_topic1`
