...
CREATE TABLE IF NOT EXISTS `engineering`.`course` (
  ...
  `professor_id` INT(20) NOT NULL,
  `subject_list_subject_list_id` INT(20) NOT NULL,
  ...
  INDEX `fk_course_subject_list1_idx` (`subject_list_subject_list_id` ASC),
  ...
  CONSTRAINT `fk_offering_professor1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_course_subject_list1`
    FOREIGN KEY (`subject_list_subject_list_id`)
...
CREATE TABLE IF NOT EXISTS `engineering`.`subject` (
  ...
  INDEX `fk_subject_course1_idx` (`course_course_id` ASC),
