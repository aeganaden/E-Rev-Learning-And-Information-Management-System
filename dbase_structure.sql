...
CREATE TABLE IF NOT EXISTS `engineering`.`data_scores` (
  ...
  `student_scores_id` INT(20) NULL,
  PRIMARY KEY (`data_scores_id`),
  INDEX `fk_data_scores_student_scores1_idx` (`student_scores_id` ASC),
  CONSTRAINT `fk_data_scores_student_scores1`
