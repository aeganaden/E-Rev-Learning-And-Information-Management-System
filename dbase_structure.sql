...
CREATE TABLE IF NOT EXISTS `engineering`.`student_scores` (
  ...
  INDEX `fk_student_scores_data_scores1_idx` (`data_scores_data_scores_id` ASC),
  INDEX `fk_student_scores_topic1_idx` (`topic_topic_id` ASC),
  INDEX `fk_student_scores_course1_idx` (`course_course_id` ASC),
  CONSTRAINT `fk_student_scores_data_scores1`
    FOREIGN KEY (`data_scores_data_scores_id`)
