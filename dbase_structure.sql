...
CREATE TABLE IF NOT EXISTS `engineering`.`attendance_in` (
  ...
  INDEX `fk_attendance_in_lecturer1_idx` (`lecturer_id` ASC),
  INDEX `fk_attendance_in_offering1_idx` (`offering_id` ASC),
  INDEX `fk_attendance_in_schedule1_idx` (`schedule_id` ASC),
  CONSTRAINT `fk_attendance_in_lecturer1`
    FOREIGN KEY (`lecturer_id`)
    REFERENCES `engineering`.`lecturer` (`lecturer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attendance_in_offering1`
    FOREIGN KEY (`offering_id`)
    REFERENCES `engineering`.`offering` (`offering_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attendance_in_schedule1`
...
CREATE TABLE IF NOT EXISTS `engineering`.`attendance_out` (
  ...
  INDEX `fk_attendance_out_lecturer1_idx` (`lecturer_id` ASC),
  INDEX `fk_attendance_out_offering1_idx` (`offering_id` ASC),
  INDEX `fk_attendance_out_schedule1_idx` (`schedule_id` ASC),
  CONSTRAINT `fk_attendance_out_lecturer1`
    FOREIGN KEY (`lecturer_id`)
    REFERENCES `engineering`.`lecturer` (`lecturer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attendance_out_offering1`
    FOREIGN KEY (`offering_id`)
    REFERENCES `engineering`.`offering` (`offering_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_attendance_out_schedule1`
    FOREIGN KEY (`schedule_id`)
    REFERENCES `engineering`.`schedule` (`schedule_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
