...
CREATE TABLE IF NOT EXISTS `engineering`.`enrollment` (
  ...
  `passingPercentage` INT(45) NOT NULL DEFAULT 70,
...
-- -----------------------------------------------------
-- Table `engineering`.`remedial_coursewares`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `engineering`.`remedial_coursewares` (
  ...
  CONSTRAINT `fk_remedial_coursewares_student_scores1`
    ...
    REFERENCES `engineering`.`student_scores` (`student_scores_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `engineering`.`student_list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `engineering`.`student_list` (
  `student_id` INT(20) NOT NULL,
  `firstname` VARCHAR(45) NOT NULL,
  `midname` VARCHAR(45) NOT NULL,
  `lastname` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `engineering`.`remedial_student_answer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `engineering`.`remedial_student_answer` (
...
-- -----------------------------------------------------
-- Table `engineering`.`remedial_grade_assessment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `engineering`.`remedial_grade_assessment` (
  ...
  CONSTRAINT `fk_remedial_grade_assessment_remedial_coursewares1`
    ...
    REFERENCES `engineering`.`remedial_coursewares` (`remedial_coursewares_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `engineering`.`login_sessions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `engineering`.`login_sessions` (
