...
<div class="row container">
    <div class="col s4">
        <blockquote class="color-primary-green">
            <h3 class="color-black">View Sections<a href="<?= base_url() ?>Sections/add/<?php echo $this->uri->segment(3); ?>" class="waves-effect waves-dark btn bg-primary-green"><i class="material-icons left">add</i>Add Section</a></h3>
        </blockquote>
    </div>
