...
<ul id="slide-out" class="side-nav bg-color-white ">
    ...
    <?php endif ?>
    <?php /*if ($info["identifier"] == "fic" || $info["identifier"] == "professor"):*/ ?> <!-- commented for presentation purpose--> 
    <?php if ($info["identifier"] == "fic"):?>
        <li class="color-black">
    ...
    <?php if ($info["identifier"] == "professor"): ?>
        <li class="color-black">
            <a href="<?= base_url() ?>Topic" class="color-black"><i class="material-icons color-black">assignment</i>Topic Area</a>
        </li>
    <?php endif ?>
